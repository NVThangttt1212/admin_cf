...
class User
{
    ...
    public static function login($email, $password)
    {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($row['role'] == 'manager') {
                ...
                header('Location:http://localhost/admin_cf/?table=order');
    ...
    public static function deleteUser($id)
    {
        ...
        if (DB::connect()->query($sql) === TRUE) {
            header('Location:http://localhost/admin_cf/?table=account');
        } else {
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '
                        ...
                        <a href="http://localhost/admin_cf/?table=account"><i class="fa-solid fa-house" style="font-size: 30px; margin: 10px 0 10px 34px"></i></a>
                    ';
                }
                die();
            }
